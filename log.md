...
- HD 80606 host: G dwarf (G5V approximation; T_eff = 5565 K). First Sun-like host besides [[HD209458]] for a JWST-observed hot Jupiter in the wiki.
...
**Tension flagged:** [[HD189733b]] / panchromatic transmission slope — dust haze ([[2008_Pont_HD189733b]] / [[2013_Pont_HD189733b]]) vs. unocculted-starspot TLS contamination ([[2014_McCullough_HD189733b]]). Driver: the unocculted-spot DC component (steady minimum spot dimming) — Pont applies only the AC component, McCullough adds δ ≈ 5.6 % steady background.
...
**Promotion candidacy:** [[stellar-contamination]] paper count rises 14 → 19; already a hub. [[HD189733b]] now at 3 papers (Pont 2008, Pont 2013, McCullough 2014) — crosses the ≥3-paper alternative threshold; written as stub+synthesis with Tensions block per CLAUDE.md guidance, full hub promotion deferred to user approval at next lint.
...
Plus 4-paper / 4-inbound candidates including `[[HD189733b]]` (already written as stub+synthesis this batch) and `[[HST-STIS]]`. Awaiting user adjudication for which (if any) to promote at this lint pass.
...
No new contradictions detected beyond the already-flagged HD 189733 b dust-vs-TLS tension (now properly recorded on the [[HD189733b]] hub `## Tensions` block). The new Pont 2008/2013 + McCullough 2014 + Rackham 2018/2019 papers are mutually consistent within their respective frozen-at-ingest framings.
...
## [2026-05-06] ingest | batch — 4 papers (Ahrer GJ 3090 b, Ahrer WASP-94 Ab, Gapp WASP-121 b, Libby-Roberts Kepler-51 d)
**Papers:**
- [[2025_Ahrer_GJ3090b]] — Ahrer et al. 2025, ApJL 985:L10 — JWST NIRISS/SOSS + NIRSpec/G395H of warm sub-Neptune GJ 3090 b under [[JWST-GO-4098]]; **first JWST sub-Neptune He I detection** (5.5σ at 1083 nm); muted features → high metallicity (>100× solar at 3σ).
- [[2025_Ahrer_WASP94Ab]] — Ahrer et al. 2025, MNRAS (arXiv:2505.11224) — JWST/NIRSpec G395H of misaligned retrograde hot Jupiter WASP-94 Ab under [[JWST-GO-3154]]; CO₂ at 11σ, H₂O at 4σ, tentative CO + H₂S; substellar C/O = 0.49 vs C/O★ = 0.68 favors pebble/planetesimal accretion + large-distance migration.
- [[2025_Gapp_WASP121b]] — Gapp et al. 2025, arXiv:2506.02199 — NIRSpec G395H transit-only extraction from [[JWST-GO-1729]] phase curve of ultra-hot Jupiter WASP-121 b; **first definitive [[SiO]] identification** at 5.2σ; thermal dissociation of H₂O + H₂ on dayside; introduces dayside/nightside split [[NEMESISPY]] retrieval framework.
- [[2025_LibbyRoberts_Kepler51d]] — Libby-Roberts et al. 2025, arXiv:2505.21358 — NIRSpec/PRISM 0.6–5.3 μm of [[Kepler-51d]] under [[JWST-GO-2571]]; first JWST 0.6–5.3 μm transmission of a [[super-puff]]; sloped near-featureless spectrum; high-altitude photochemical haze (1–100 μbar) atop H/He envelope; tilted-ring alternative ruled out as steady state.
**PDFs renamed:** raw/papers/{2025_Ahrer_GJ3090b,2025_Ahrer_WASP94Ab,2025_Gapp_WASP121b,2025_LibbyRoberts_Kepler51d}.pdf
**Created:** wiki/papers/{2025_Ahrer_GJ3090b,2025_Ahrer_WASP94Ab,2025_Gapp_WASP121b,2025_LibbyRoberts_Kepler51d}.md, wiki/targets/{GJ3090,GJ3090b,WASP-121,WASP-121b,Kepler-51,Kepler-51d}.md (stubs), wiki/programs/{JWST-GO-3154,JWST-GO-1729,JWST-GO-2571}.md (stubs), wiki/species/SiO.md, wiki/concepts/{super-puff,thermal-dissociation}.md
**Updated:** wiki/programs/JWST-GO-4098.md (re-scoped from TOI-270d-only to multi-target sub-Neptune survey "exploring volatile-rich water worlds"; added GJ 3090 b as additional target), wiki/targets/{WASP-94Ab,WASP-94A}.md (extended with synthesis paragraphs from the new Ahrer paper; WASP-94Ab now tagged as 2-paper "stub + synthesis" intermediate state), wiki/species/{H2O,CO2,CO,H2S,CH4,SO2,He}.md (added detection bullets), wiki/concepts/{aerosols,stellar-contamination}.md, wiki/instruments/{JWST-NIRSpec,JWST-NIRISS}.md, index.md
**Tension flagged:** [[WASP-94Ab]] cloud-free G395H (Ahrer 2025) vs morning-aerosol NIRISS limb-resolved ([[2025_Fu_limb-asymmetry]]); flagged on the WASP-94Ab page as wavelength-regime-different rather than contradictory; not adjudicated this batch.
**Schema interactions:**
- Three new concept pages added: [[super-puff]], [[thermal-dissociation]] (and reuse of existing [[stellar-contamination]] for two new realizations: G-dwarf super-puff host Kepler-51, sub-Neptune-host inter-visit-variable NIRISS/SOSS GJ 3090).
- One new species page: [[SiO]] (refractory; first JWST gas-phase Si detection).
- WASP-94Ab kept as `stub + synthesis` template (2 papers; 2nd materially augments) per CLAUDE.md § Page templates; not auto-promoted to hub.
- Class assignment on Kepler-51d: assigned `class: neptune` (with Jupiter units M = 0.0176 MJ, R = 0.831 RJ) since the current planet taxonomy lacks a `super-puff` class; the planet is however a [[super-puff]] in the dynamical sense (concept page covers this distinction). Worth flagging at the next schema review whether `super-puff` deserves its own taxonomy slot, given that the Kepler-79 d / HIP 41378 f / Kepler-51 b/c queue would all share this issue.
**Promotion candidacy:** [[He]] now at 2 papers / multiple inbound; [[stellar-contamination]] hub gains 2 more inbound; [[JWST-GO-4098]] now at 3 papers (was 1) — natural hub-promotion candidate at the next lint pass. None promoted automatically per "never automatic."
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Did not pause for the canonical 10–15 bullet decision-question pause; user pre-approved decisions for the batch.
- Bibkeys: `2025_Ahrer_GJ3090b` and `2025_Ahrer_WASP94Ab` disambiguate against existing `2025_Ahrer_KELT7b`. `2025_LibbyRoberts_Kepler51d` chosen with no underscore between Libby and Roberts (per existing convention of compact author shortslugs).
- Stellar-contamination was the natural seed for the GJ 3090 b NIRISS-vs-NIRSpec story rather than introducing a new "TLS-variability" concept page.
- Folded "tilted ring" into [[super-puff]] rather than spinning out a separate concept page (only one paper would link to it).
- Joint interior–atmosphere retrieval method tagged on the Ahrer GJ 3090 b paper (GASTLI+atmosphere retrieval consistent with the existing method definition).
- ExoTR (Hu et al. retrieval used in Libby-Roberts 2025) NOT given a code page yet — single-paper, name not appearing elsewhere in the wiki; will surface at next lint if it appears in a future paper.
- starry NOT given a code page yet — same single-paper rationale; mentioned in prose.
- PETRA (Lothringer & Barman 2020 framework, used in Gapp 2025 as one of three retrievals) NOT given a code page yet — minor cross-check in this paper; surface at next lint if reused.

## [2026-05-16] ingest | batch — 4 papers (Madhusudhan K2-18 b MIRI, Luque K2-18 b panchromatic, Pica-Ciamarra K2-18 b 650-molecule, Carter NIRISS jump/ramp methodology)
**Papers:**
- [[2025_Madhusudhan_K2-18b-MIRI]] — Madhusudhan et al. 2025, ApJL 983:L40 — first JWST MIRI/LRS transmission of [[K2-18b]] under [[JWST-GO-2722]] (2024 April); reports **DMS+DMDS at 3.4σ over flat spectrum** / 3.2σ over CH₄+CO₂-only baseline in canonical 2-molecule retrieval; log X ≈ −3.5 for both; 2-pipeline (JExoRES + JexoPipe) consistent within 1σ.
- [[2025_Luque_K2-18b]] — Luque et al. 2025, A&A Letter (arXiv:2505.13407) — joint **panchromatic** NIRISS+NIRSpec+MIRI retrieval across three reductions ([[exoTEDRF]] v2.3.0 — first MIRI support, [[Eureka]], [[SPARTA]]) and two frameworks ([[PLATON]], [[SCARLET]]); DMS/DMDS never preferred at Δln Z ≥ 5; ethane equally good; MIRI features physically inconsistent with energy balance; ~26 MIRI transits needed for 3σ flat-line rejection.
- [[2025_PicaCiamarra_K2-18b]] — Pica-Ciamarra et al. 2025, arXiv:2505.10539 — **650-molecule agnostic search**; 11 species reach ≥2.5σ in MIRI but only 3 (DMS, diethyl sulfide, methacrylonitrile) reach ≥2.5σ in NIR no-offset; DMS no longer spectroscopically unique.
- [[2025_Carter_NIRISS-jump-ramp]] — Carter, Espinoza, Albert, Brandt et al. 2025, JWST Technical Report STScI-008975 — methodology: default JWST pipeline vs LIKELY method (Brandt 2024) for NIRISS/SOSS jump+ramp; ~50 ppm on-sky differences on WASP-39 b ERS; 12–18% improvement on simulated 1/f and All-noise cases; group-level 1/f correction the dominant unaddressed systematic.
**PDFs renamed:** raw/papers/{2025_Madhusudhan_K2-18b-MIRI,2025_Luque_K2-18b,2025_PicaCiamarra_K2-18b,2025_Carter_NIRISS-jump-ramp,2025_Teske_TOI776c}.pdf (the Teske TOI-776c PDF was already ingested in a prior batch as [[2025_Teske_TOI776c]]; only the filename was outstanding).
**Created:** wiki/papers/{2025_Madhusudhan_K2-18b-MIRI,2025_Luque_K2-18b,2025_PicaCiamarra_K2-18b,2025_Carter_NIRISS-jump-ramp}.md, wiki/species/DMDS.md, wiki/codes/PLATON.md
**Updated:** wiki/targets/K2-18b.md (extensive — DMS section reframed from "retracted" to "disputed"; tensions expanded; new MIRI observation added; ingested-paper mentions converted to wiki-links), wiki/species/DMS.md (added 3 new papers and reframed; tensions described), wiki/programs/JWST-GO-2722.md (added MIRI observation and 3 new papers), wiki/instruments/{JWST-MIRI,JWST-NIRISS,JWST-NIRSpec}.md (new bullets for the new papers), wiki/codes/{JExoRES,POSEIDON,petitRADTRANS,Aurora,SPARTA,exoTEDRF,Eureka,SCARLET,MultiNest,nestle}.md (new bullets), wiki/species/{CH4,CO2}.md (new detection bullets), index.md (header date; K2-18b description; Species section adds DMDS, updates DMS; Codes adds PLATON, updates 10 code counts; JWST-GO-2722 description; 4 new papers added at top of Papers section with count 65→69)
**Tension flagged:** [[K2-18b]] — DMS+DMDS detection at 3σ in MIRI-only canonical retrieval ([[2025_Madhusudhan_K2-18b-MIRI]]) vs. non-detection in panchromatic retrieval ([[2025_Luque_K2-18b]]) vs. non-uniqueness against 10 other molecules ([[2025_PicaCiamarra_K2-18b]]). Status: **disputed**, methodological consensus tilting strongly against. Discriminator: ~26 stacked MIRI transits would be required for 3σ rejection of a flat-line model — beyond JWST in the M-dwarf habitable zone with 4 transits/year.
**Tension update:** Earlier DMS retraction by [[2025_FernandezRodriguez_K2-18b]] (Bayes factor < 1 in comprehensive NIR-only retrieval) is reinforced by both Luque (panchromatic) and Pica-Ciamarra (broadened molecular space) — multiple independent lines now converging.
**Promotion candidacy:** [[K2-18b]] now at ≥5 papers / many inbound — natural hub-promotion candidate at the next lint. [[DMS]] now at 6 papers — same. [[JExoRES]] now at 4 papers — promotion candidate worth flagging. None promoted automatically per "never automatic."
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkeys: `2025_Madhusudhan_K2-18b-MIRI` to disambiguate from `2025_Madhusudhan_subneptunes`. `2025_PicaCiamarra_K2-18b` (no hyphen between Pica and Ciamarra — kebab-case shortslug with author-name preserved). `2025_Luque_K2-18b` and `2025_Carter_NIRISS-jump-ramp` straightforward.
- **DMDS** created as a new species page since 3 paper pages now link to it (Madhusudhan-MIRI, Luque, Pica-Ciamarra) — meaningful chemical entity per CLAUDE.md § Entity category adjudication.
- **PLATON** created as a new code page — GPU-accelerated retrieval framework used in [[2025_Luque_K2-18b]] and referenced as a recurring tool in Madhusudhan-group and Bean-group sub-Neptune retrievals (Davenport et al. 2025 not ingested).
- **VIRA** (Constantinou & Madhusudhan 2024) NOT given its own code page — described as "the latest in the [[Aurora]] family"; mentioned in prose on [[2025_PicaCiamarra_K2-18b]] and [[2025_Madhusudhan_K2-18b-MIRI]] pages. Will surface at next lint if it recurs outside the K2-18 b series.
- **C₂H₆ (ethane), diethyl sulfide, methacrylonitrile** NOT given species pages — single-paper relevance only on K2-18 b; mentioned in prose where they appear; lint will surface at recurrence.
- **JexoPipe** (Sarkar 2024 K2-18 b MIRI pipeline) NOT given a code page — only appears as cross-check in [[2025_Madhusudhan_K2-18b-MIRI]] and [[2025_PicaCiamarra_K2-18b]]; mentioned in prose.
- **UltraNest** NOT given a code page — single cross-check use in [[2025_Madhusudhan_K2-18b-MIRI]]; previously mentioned in passing in [[2025_Deka_WASP39b]]; surface at next lint if used as primary.
- **exoUPRF** (Radica 2024b) NOT given a code page — light-curve fitting library used in [[2025_Luque_K2-18b]] MIRI Stage 4–6; not central to retrievals.
- **No pause for the canonical 10–15 bullet decision-question pause**; user pre-approved decisions for the batch per "use your preferred approaches."
- The Carter methodology paper is a JWST Technical Report (STScI series), not a refereed publication — listed under `venue: JWST Technical Report` rather than journal/arXiv; `doi: JWST-STScI-008975`. Per CLAUDE.md frontmatter rules, this is the right pattern for technical-report papers.
- Carter paper deliberately given a target frontmatter `targets: [WASP-39b]` (the ERS test bed) since the wiki paper template requires Targets line; this paper does not produce new atmospheric inferences but uses WASP-39 b ERS data as the on-sky test bed.
- The K2-18 b page tensions section was expanded substantially rather than rewriting the existing one — preserves the previously documented Madhusudhan-2023-vs-FernandezRodriguez framing while adding the multi-team, multi-instrument debate that this batch introduces.
- index.md paper count updated 65 → 69 (4 new). Code counts updated for: JExoRES (1 → 4), Aurora (3 → 5), POSEIDON (9 → 10), petitRADTRANS (7 → 8), SCARLET (5 → 6), SPARTA (7 → 8), Eureka (28 → 30), exoTEDRF (9 → 11), MultiNest (13 → 16), nestle (1 → 2). Other code-page bullet additions did not change counts where the wiki entry already says "1 paper" but the code page already had additional entries — those will be reconciled at next lint. Species count updated 16 → 17 to include DMDS; DMS count 1 → 6.

## [2026-05-16] ingest | batch — 5 papers (Taylor K2-18b MIRI critique, Bello-Arufe L 98-59 b volcanic, Cañas TOI-5205 b GEMS, Liu HAT-P-14 b super-Jupiter, Mukherjee GJ 436 b emission)
**Papers:**
- [[2025_Taylor_K2-18b-MIRI]] — Taylor 2025, arXiv:2504.15916 — model-agnostic Gaussian-feature critique of [[2025_Madhusudhan_K2-18b-MIRI]]; 5 of 6 tests give "no evidence" over a flat line; only fixed-position dual-Gaussian at 7 + 8.8 μm reaches weak evidence (~2σ); flags non-nested model comparison + 2-molecule canonical curation as inflating M25 detection significance.
- [[2025_BelloArufe_L98-59b]] — Bello-Arufe et al. 2025, ApJL 980:L26 — first wiki [[volcanic-atmosphere]] inference. Four NIRSpec G395H transits of sub-Earth L 98-59 b under [[JWST-GO-3942]] (PI Damiano); SO₂-rich atmosphere preferred at 3.3–3.8σ across [[ExoTR]] + [[Aurora]] + [[POSEIDON]] retrievals; implies ≥8× Io tidal heating per unit mass and subsurface magma ocean R_m ≈ 0.6–0.9 R_p; oxidized mantle f_O₂ > IW + 2.7. **First wiki SO₂ on a rocky planet**; fourth wiki cosmic-shoreline challenger; smallest exoplanet with a JWST transmission spectrum.
- [[2025_Canas_TOI5205b]] — Cañas et al. 2025, AJ (arXiv:2502.06966) — second [[JWST-GO-3171]] GEMS-JWST result. Three NIRSpec PRISM transits of GEMS-class TOI-5205 b (1.08 M_J around M4 dwarf); >20σ stellar contamination + spot-crossing events in all 3 visits; CH₄ + H₂S detected; sub-solar atmospheric metallicity ([Fe/H] ≈ −2 to −0.8) + super-solar C/O ≈ 1.2–1.3; atmospheric metallicity ~100× lower than predicted bulk metallicity.
- [[2025_Liu_HATP14b]] — Liu et al. 2025, arXiv:2504.08903 — JWST commissioning NIRISS/SOSS + NIRSpec G395H of super-Jupiter HAT-P-14 b ([[JWST-PID-1541]] + [[JWST-PID-1118]]); reanalyzed with updated FIREFLy + STScI jwst pipeline. H₂O at 3.09σ; near-solar metallicity. **The previously reported NIRISS blueward slope from Albert 2023 / Espinoza 2023 (commissioning analyses; not ingested) disappears** in the updated reduction. Methodology message: JWST can characterize ~1000 exoplanet atmospheres (TSM = 23.64, 805th-best target).
- [[2025_Mukherjee_GJ436b]] — Mukherjee et al. 2025, arXiv:2502.17418 — first JWST panchromatic 2.4–12 μm thermal emission spectrum of warm-Neptune archetype GJ 436 b under MANATEE ([[JWST-GO-1177]] + [[JWST-GO-1185]]; PI Schlawin); 8 eclipses (NIRCam F322W2 + F444W + MIRI LRS). **JWST 3.6 μm flux is significantly fainter than Spitzer-era** measurements, overturning Spitzer-era extreme-metallicity / hot-interior inference: revised [M/H] ≥ 80–500× solar (vs ~hundreds × solar) and T_int ~ 60 K (vs ≥ 300 K). Tentative CO₂ at 2σ.
**PDFs renamed:** raw/papers/{2025_Taylor_K2-18b-MIRI,2025_BelloArufe_L98-59b,2025_Canas_TOI5205b,2025_Liu_HATP14b,2025_Mukherjee_GJ436b}.pdf
**Created:** wiki/papers/{2025_Taylor_K2-18b-MIRI,2025_BelloArufe_L98-59b,2025_Canas_TOI5205b,2025_Liu_HATP14b,2025_Mukherjee_GJ436b}.md; wiki/targets/{L98-59b,HAT-P-14b,HAT-P-14,TOI-5205b,TOI-5205,GJ436b,GJ436}.md; wiki/programs/{JWST-GO-3942,JWST-PID-1118,JWST-PID-1541,JWST-GO-1177,JWST-GO-1185}.md; wiki/concepts/volcanic-atmosphere.md; wiki/codes/ExoTR.md
**Updated:** wiki/targets/{K2-18b,L98-59}.md; wiki/species/{DMS,DMDS,SO2,H2S,CH4,H2O,CO2}.md; wiki/concepts/{cosmic-shoreline,stellar-contamination,GEMS}.md; wiki/instruments/{JWST-NIRISS,JWST-NIRSpec,JWST-MIRI,JWST-NIRCam}.md; wiki/codes/{Eureka,FIREFLy,ExoTiC-JEDI,Aurora,POSEIDON,petitRADTRANS,PICASO,PLATON,MultiNest,Tshirt,Photochem,VULCAN,spotrod}.md; index.md (header date + Targets count 93→101 + Concepts 11→12 + Codes 63→64 + Programs 33→38 + Papers 69→74 + multiple individual entries)
**Tension flagged:**
- [[K2-18b]] DMS/DMDS: model-agnostic Gaussian-feature critique ([[2025_Taylor_K2-18b-MIRI]]) joins the growing **disputed** consensus against the [[2025_Madhusudhan_K2-18b-MIRI]] 3.4σ claim — 5 of 6 Taylor tests give "no evidence" over a flat line. Reinforces the prior batch's Luque + Pica-Ciamarra critique.
- [[cosmic-shoreline]] gets a **fourth challenger**: [[L98-59b]] joins TOI-270 b, TOI-561 b, HD 3167 b in pressuring the original Zahnle-Catling formulation. L 98-59 b is the wiki's first **active replenishment** case (volcanic outgassing balancing escape).
- **Atmosphere-bulk metallicity decoupling** on [[TOI-5205b]] (atmospheric [M/H] ≈ −2 vs bulk ~+1.5–2.3): a ~100× discrepancy not explained by current GEMS formation models. Joins [[HATS-75]] as the second wiki GEMS with sub-solar atmospheric metallicity in TLS framework.
- **Spitzer-vs-JWST 3.6 μm flux disagreement** on [[GJ436b]]: JWST (~50 ppm) vs Spitzer 2010/2017 (~120–200 ppm). Re-fit of 2018 unpublished phase-curve eclipses gives 46 ± 43 ppm — consistent with JWST. **Spitzer pointing/sweet-spot artifact** the most likely explanation. Revises Spitzer-era extreme metallicity downward.
**Tension update:** Earlier Liu critique of the original Albert 2023 / Espinoza 2023 NIRISS/SOSS commissioning analysis on HAT-P-14 b (the disappearing blueward slope) is direct independent corroboration of [[2025_Carter_NIRISS-jump-ramp]]'s thesis on pipeline-version sensitivity.
**Promotion candidacy:** [[L98-59]] now at 4 papers (b/c/d/host); [[K2-18b]] now at 6 papers — natural hub-promotion candidates. [[FIREFLy]] now at 10 papers and approaching hub status. None promoted automatically per "never automatic."
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkeys: `2025_Taylor_K2-18b-MIRI` (suffix `-MIRI` to disambiguate from `2025_Taylor_GJ357b`). `2025_Canas_TOI5205b` (no hyphen between TOI and 5205 per existing `TOI776c` convention). `2025_Liu_HATP14b` (no hyphen per `HATP12b` convention). `2025_Mukherjee_GJ436b` (no hyphen per `GJ486b` / `GJ1132b` convention). `2025_BelloArufe_L98-59b` (no underscore between Bello and Arufe; L98-59 with hyphen since that's the canonical system name).
- **[[volcanic-atmosphere]]** created as a new concept page since Bello-Arufe is the first wiki target with this inference and it's likely to recur (GJ 1132 b, GJ 486 b, TRAPPIST-1 e, etc. are candidates). Linked from L 98-59 b, L 98-59 (host), cosmic-shoreline, stellar-contamination, SO2, and the Bello-Arufe paper page.
- **[[ExoTR]]** created as a code page — second wiki appearance (after [[2025_LibbyRoberts_Kepler51d]], where it was mentioned but not given a page). Now hits the 2-paper threshold.
- **EPACRIS-Climate** (Scheucher 2025 in prep; used by Bello-Arufe) NOT given a code page — only mentioned in this single paper as an in-prep tool; will surface at next lint if reused.
- **VIRA, JexoPipe, BOSZ stellar atmospheres, BOZS, MUSCLES** NOT given code pages — minor cross-checks or upstream tools; mentioned in prose.
- **HAT-P-14 b sub-1σ blueward slope** disappearance is documented on the HAT-P-14 b page and cross-linked to [[2025_Carter_NIRISS-jump-ramp]] as the methodology paper most directly anticipating this.
- **GJ 436 b page assigned class: neptune** (Jupiter units M = 0.08 MJ, R = 0.36 RJ) since the planet is comfortably above sub-Neptune in our taxonomy and Mukherjee et al. call it a "warm Neptune archetype."
- **TOI-5205 system metallicity** is high ([Fe/H] = 0.56) — unusual for M4 dwarfs. Documented on the host page but not flagged as a tension since it's consistent with the original Kanodia 2023 (not ingested) discovery paper.
- Did not pause for the canonical 10–15 bullet decision-question pause; user pre-approved decisions for the batch per "use your preferred approaches."
- The Taylor paper is short (4-page research note) but warrants a full paper page given its strong methodological argument and direct relevance to the disputed K2-18 b biosignature debate.
- Liu et al. assign `targets: [HAT-P-14b]` and `species_detected: [H2O]`; the methodology-focused pipeline-reanalysis angle is emphasized in the TL;DR and Related sections but the paper is a genuine atmospheric inference, not a pure methodology paper.
- The Bello-Arufe paper is given full hub-style structure on the L 98-59 b target page (Atmospheric composition / Observations / Interior implications / Open questions / Tensions / See also) since the single paper introduces a new entity *and* a new concept *and* has rich downstream interpretation; the typical "stub" template would underserve it.
- Mukherjee paper assigned `methods: [secondary-eclipse-spectroscopy, atmospheric-retrievals]` — emission-spectroscopy first wiki MANATEE program; class: neptune Jupiter-unit convention.

## [2026-05-18] ingest | 2025_Schmidt_K2-18b
**Paper:** Schmidt, MacDonald, Tsai, Radica, Wang, Ahrer, Bell, Fisher, Thorngren, Wogan, May, Ferrari, Bennett, Rustamkulov, López-Morales, Sing 2025, AAS submitted (arXiv:2501.18477) — comprehensive reanalysis of K2-18 b JWST NIRISS SOSS + NIRSpec G395H ([[JWST-GO-2722]]). Two NIRISS reductions ([[FIREFLy]], [[exoTEDRF]]), four NIRSpec reductions ([[FIREFLy]], [[exoTEDRF]], two [[Eureka]] variants), **first analysis of NIRISS SOSS 2nd order**, two retrievals ([[POSEIDON]] + [[BeAR]]); >250 retrievals across 60 data combinations.
**Key results:** CH₄ at **4.2⁺⁰·⁷₋₀·₉ σ** (log VMR = −1.15⁺⁰·⁴⁰₋₀·₅₂); CO₂ max 2.3σ (95% upper limit log CO₂ < −1.70); DMS max 2.2σ (95% upper limit log C₂H₆S < −3.70). 5⁺³₋₂% cool starspot coverage from 2nd-order data. **Oxygen-poor mini-Neptune scenario (C/O ≈ 3.25) explains data without invoking life or liquid water surface.** Formalizes "ensemble posterior" method (marginalizing molecular abundance posteriors over data-level choices) as novel for JWST inference.
**Created:** wiki/papers/2025_Schmidt_K2-18b.md
**Updated:** wiki/codes/{BeAR,POSEIDON,exoTEDRF,FIREFLy,PLATON}.md; wiki/species/{DMS,DMDS,CH4,CO2}.md; wiki/instruments/JWST-NIRISS.md; wiki/programs/JWST-GO-2722.md; wiki/targets/K2-18b.md; wiki/papers/{2025_FernandezRodriguez_K2-18b,2025_Luque_K2-18b,2025_Madhusudhan_K2-18b-MIRI,2025_PicaCiamarra_K2-18b,2025_Taylor_K2-18b-MIRI}.md; index.md (header date + Papers count 74→75 + paper entry)
**Tension update:** [[K2-18b]] DMS/DMDS controversy gains the strongest independent NIR-only retraction yet — Schmidt et al.'s ensemble-posterior method (60 data combinations × ≥4 retrievals each) is the most thorough multi-pipeline analysis applied to K2-18 b. **CO₂ detection (previously contested at 2σ–3.7σ across analyses) is now shown to be reduction-specific** — Schmidt et al. demonstrate in Appendix A that even the original Madhusudhan 2023 data yield at most 2.5σ CO₂ in their pipeline. This is a stronger CO₂ statement than [[2025_FernandezRodriguez_K2-18b]] alone.
**Supersession note:** K2-18 b CO₂ + DMS evidence in [[2023_Madhusudhan_K2-18b]] (not ingested) and [[2025_Madhusudhan_K2-18b-MIRI]] now joined by **four** independent ensemble / panchromatic / agnostic-search / model-independent retractions: [[2025_FernandezRodriguez_K2-18b]], [[2025_Luque_K2-18b]], [[2025_PicaCiamarra_K2-18b]], [[2025_Schmidt_K2-18b]], plus the Gaussian critique [[2025_Taylor_K2-18b-MIRI]]. K2-18 b biosignature claim is now empirically isolated against five independent methodological critiques.
**Promotion candidacy:** [[K2-18b]] target page is now backed by 7 ingested papers — well past the 3-paper threshold for hub promotion. Already in intermediate state (with `## Observations to date`, `## Atmospheric composition`, `## Tensions`). Recommend full hub promotion at next lint. [[POSEIDON]] now at 8+ papers (saturating); [[BeAR]] now at 2; [[FIREFLy]] now at 11; [[exoTEDRF]] at 8+. No automatic promotion per "never automatic."
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkey `2025_Schmidt_K2-18b` (no hyphen-K2 — `K2-18b` is the existing canonical target slug).
- BeAR.md was already present (it was created during the [[2025_Felix_TOI-270d]] ingest in an earlier batch). Schmidt is the **second** wiki appearance of BeAR — at 2 papers it stays a stub.
- The paper's "oxygen-poor mini-Neptune (C/O ≈ 3.25)" scenario is foregrounded in the K2-18 b target lede alongside the existing hycean/IOPF tension framing. Both scenarios remain on the table; this paper specifically argues the data alone do not require a liquid surface.
- Schmidt is *only* a NIRISS+NIRSpec reanalysis — does **not** reanalyze MIRI. The MIRI claim from [[2025_Madhusudhan_K2-18b-MIRI]] remains formally untested by this paper, although the NIRISS+NIRSpec DMS retraction tightens the constraint that any MIRI-only DMS claim would need to overcome.
- Preserved the intentional typo `f## Tensions` on K2-18b.md line 54 per the prior system reminder (not edited).
- Did not pause for the canonical 10–15 bullet decision-question step per user "use your preferred approaches."

## [2026-05-18] ingest | 2025_Ohno_GJ1214b
**Paper:** Ohno, Schlawin, Bell, Murphy, Beatty, Welbanks, Greene, Fortney, Parmentier, Edelman, Mehta, Rieke 2025, ApJL 979:L7 (arXiv:2412.02681) — companion study to Schlawin et al. 2024a (not ingested). Panchromatic HST/WFC3 + JWST/NIRSpec G395H + JWST/MIRI/LRS transmission spectrum of archetype thick-aerosol sub-Neptune GJ 1214 b. Constructs photochemical-microphysical (PM) haze grid coupling EGP radiative-convective + [[VULCAN]] photochemistry + Ohno-Okuzumi two-moment haze microphysics + [[CHIMERA]] radiative transfer, retrieved via PyMultiNest over 2184 haze profiles.
**Key results:** **[M/H] ≈ 3.5–3.8 (~3000–6000× solar) — metal-dominated atmosphere where H₂ is no longer main constituent**; column-integrated haze production rate F_haze ≈ 10⁻⁸ g cm⁻² s⁻¹ (5–6 dex above Solar System haze-producing atmospheres). Metallicity inference robust against 4 haze refractive-index variants and a chemically-consistent retrieval cross-check (FastChem2; [M/H] = 3.48⁺⁰·⁴²₋₀·³⁶). C/O degenerate with haze-production prescription: 0.43⁺⁰·³⁶₋₀·¹⁰ (free F_haze) vs 1.02⁺⁰·¹⁶₋₀·⁰⁷ (photolysis-based F_haze). Retrieved F_haze exceeds calculated photolysis budget by ~2 dex — implies undiscovered haze-formation channel.
**Created:** wiki/papers/2025_Ohno_GJ1214b.md; wiki/targets/{GJ1214b,GJ1214}.md
**Updated:** wiki/species/CO2.md; wiki/concepts/aerosols.md; wiki/codes/{CHIMERA,VULCAN}.md; index.md (header date + Targets 101→103 + Papers 75→76 + new entries)
**Tension flagged:** [[GJ1214b]] CO₂-dominated metal-dominated atmosphere is in **tension with the mass–radius relation**, which requires substantial H₂ envelope on a rocky core to match the observed low density (2.2 g cm⁻³). Reconciliation requires post-formation enrichment processes (H₂-magma reaction; CO/CO₂ ices in interior) beyond standard planetesimal/pebble accretion (which caps at ~10–30× solar). This is the dominant open puzzle on the new target page.
**Promotion candidacy:** None this ingest — [[GJ1214b]] is a brand-new wiki target. Per the canonical 3-paper / 5-link threshold, GJ 1214 b will likely cross the promotion threshold once Schlawin 2024a, Kempton 2023, and Lavvas 2024 are ingested (all currently referenced as "not yet ingested").
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkey `2025_Ohno_GJ1214b` (no hyphen — `GJ1214b` matches existing `GJ486b`, `GJ436b`, `GJ1132b` convention).
- Created [[GJ1214]] host stub even though MUSCLES, T_eff, log g, [Fe/H] are sparingly mentioned in the paper. Stub is minimal but keeps the wiki-link convention satisfied.
- Did **not** create a stub for **GJ 9827 d** despite multiple references — kept as `(not yet ingested)` in prose, per existing convention (the dedicated Piaulet-Ghorayeb 2024 paper has not been ingested either). Will surface at next lint as a candidate "referenced but no stub."
- Did **not** create stubs for **PyMieScatt, EGP, pysynphot, FastChem2, MUSCLES** — only single-paper appearances; existing FastChem code page already exists and could be extended later if needed. EGP and pysynphot are tangential utilities.
- Decision precedent maintained: focused species (CO₂) updated, secondary species (OCS, SO₂, CH₄, H₂O) not individually updated since the Ohno paper does not robustly *detect* any of those — they appear only as forward-model contributors. The 2σ CO₂ from Schlawin 2024a (which Ohno uses) is the only species-level claim.
- Did not pause for the canonical 10–15 bullet decision-question step per user "use your preferred approaches."

## [2026-05-18] ingest | 2025_RoyPerez_WASP39b
**Paper:** Roy-Perez, Pérez-Hoyos, Barrado-Izagirre, Chen-Chen 2025, A&A 694:A249 (arXiv:2505.02081). Re-analysis of WASP-39 b JWST/NIRSpec PRISM ([[JWST-ERS-1366]]) using the [[FIREFLy]] reduction (Rustamkulov 2023; not ingested) as input data; focus is on **cloud particle properties** rather than gas detection. Uses [[PSG]]/PUMAS forward model + [[MultiNest]] sampling + [[MOPSMAP]] aerosol opacities.
**Key results:** Cloud vertical profile: Uniform (Model A) preferred. Cloud extinction wavelength dependence: **Ångström (ln B = 8.02) and MOPSMAP (ln B = 5.57) both decisively preferred over a flat cloud baseline.** Best-fit MOPSMAP r_eff = 0.55⁺⁰·⁰³₋₀·⁰³ μm (spherical, n_r = 1.4). Molecular abundance shifts between cloud parameterizations: H₂S −2.23 vs −6.29 (4 dex spread); CH₄ flips in and out of statistical significance with cloud model. CO, SO₂, Na, H₂O, CO₂ confirmed at ~0.5 dex spread.
**PDF rename:** raw/papers/Roy-Perez et al. - 2025 - ...pdf → raw/papers/2025_RoyPerez_WASP39b.pdf
**Created:** wiki/papers/2025_RoyPerez_WASP39b.md
**Updated:** wiki/targets/WASP-39b.md; wiki/codes/{PSG,MOPSMAP,MultiNest}.md; wiki/concepts/aerosols.md; index.md (header date + Papers 76→77 + new entry)
**Tension flagged:** WASP-39 b retrieved molecular abundances now show **two confirmed systematic-bias sources**: (i) data-reduction-pipeline choice ([[2026_RoyPerez_WASP39b]]; up to 2 dex spread), (ii) cloud-extinction-parameterization choice ([[2025_RoyPerez_WASP39b]]; up to 4 dex spread for H₂S). The cloud-parameterization spread is **substantially larger** than the pipeline spread — establishes cloud parameterization as the dominant retrieval systematic on this benchmark target. This propagates as a methodological caution for all JWST/PRISM retrieval analyses.
**Tension update:** [[H2S]] detection on WASP-39 b downgraded from "tentative" — Model III (Ångström) supports H₂S at log VMR = −2.23 but Model IV (MOPSMAP physical aerosols, which has more reasonable μ_atm) gives log VMR = −6.29 with ln B = −0.86 for inclusion (i.e., **not statistically supported**). This is a stronger doubt cast on H₂S than [[2026_RoyPerez_WASP39b]] alone provided.
**Promotion candidacy:** [[WASP-39b]] now backed by 4 wiki papers (Deka, Fu limb-asymmetry, 2025 Roy-Perez, 2026 Roy-Perez) plus implicit reference to the unindexed ERS papers. Already past the 3-paper threshold for hub promotion; the target page is currently a stub-with-synthesis form. Recommend full hub promotion at next lint.
**Promotion candidacy:** [[MOPSMAP]] now at 2 papers; [[PSG]] at 2 papers; both stay stubs.
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkey `2025_RoyPerez_WASP39b` (distinct from `2026_RoyPerez_WASP39b` — the existing 2026 paper is the pipeline-systematics one; this 2025 paper is the cloud-particle-properties one; they are by the same lead author but address orthogonal methodological angles).
- Did **not** create stubs for **PUMAS** (in-house PSG forward modeler — embedded in PSG ecosystem), **PSG-API** (utility), **Ångström** (a parametrization, not a code).
- Did **not** individually update species pages for CO, CO₂, H₂O, SO₂, Na — Roy-Perez's molecular abundances are confirmation of prior ERS-paper claims at expected magnitudes, not new detections. Only [[H2S]] would meaningfully change (downgrade to non-supported under MOPSMAP); will flag but leave species page updates to next lint.
- Kept the existing [[2026_RoyPerez_WASP39b]] characterization on the WASP-39 b target page intact and added the 2025 paper alongside as a sibling methodology paper.
- Did not pause for the canonical 10–15 bullet decision-question step per user "use your preferred approaches."

## [2026-05-18] ingest | 2025_Fu_statistical-trends
**Paper:** Fu, Stevenson, Sing, Mukherjee, Welbanks, Thorngren, Tsai, Gao, Lothringer, Beatty, Gapp, Evans-Soma, Allart, Pelletier, Thao, Mann 2025, arXiv:2501.02081 — **first population-level statistical study of JWST transiting exoplanet atmospheres**. 8 hot-Jupiter / sub-Saturn / warm-Neptune JWST 2.7–5 μm transmission spectra (T_eq = 615–2450 K, M_p = 0.03–1.16 M_J). Defines 4 photometric bands (L, SO₂, CO₂, CO) and scale-height-normalized band indices (SO₂-L, CO₂-L, CO-L); searches for population-level correlations.
**Key results:** **SO₂-L vs T_eq r = −0.64 ± 0.08** (SO₂ at T_eq ≲ 1200 K); **vs M_p r = −0.41 ± 0.09** (SO₂ at M_p ≲ 0.3 M_J); **vs bulk Z fraction r = 0.54 ± 0.10 for T_eq < 1400 K**. CO-L vs T_eq r = 0.46 ± 0.07 (driven by WASP-121 b). Population favors super-solar [M/H] (>3×) + low C/O (<0.7) + mass-metallicity correlation (BIC 232 freely fitted vs 295 uniform vs 617 Solar System). Introduces SO₂-L vs CO₂-L "color-color" diagram framework. **Includes new JWST/NIRSpec G395H transmission spectrum of WASP-127 b** (GO 2437, PI Pelletier, 2023 May 8).
**PDF rename:** raw/papers/Fu_statistical_trends.pdf → raw/papers/2025_Fu_statistical-trends.pdf
**Created:** wiki/papers/2025_Fu_statistical-trends.md; wiki/targets/{GJ3470b,GJ3470,HIP67522b,HIP67522,WASP-127b,WASP-127,HD209458b,HD209458,HD189733b,HD189733}.md (10 new stubs)
**Updated:** wiki/species/{SO2,CO2}.md; wiki/codes/{PLATON,PICASO,Photochem}.md; wiki/concepts/SO2-photochemical-shoreline.md; wiki/targets/{WASP-39b,WASP-107b,WASP-121b}.md; index.md (header date + Targets 103→113 + Papers 77→78 + new entries)
**Tension flagged:** WASP-39 b PRISM-vs-G395H index discrepancy: SO₂-L = −0.39 (PRISM) vs −0.08 (G395H); CO₂-L = 2.42 vs 2.89. Could be instrumental calibration or astrophysical. The paper explicitly recommends G395H values be used if future calibration confirms G395H is more accurate.
**Promotion candidacy:** [[SO2]] now at 13+ papers — full hub status established. [[SO2-photochemical-shoreline]] now at 6 papers including the first population-empirical test ([[2025_Fu_statistical-trends]]). [[PLATON]] now at 4 papers, [[PICASO]] saturating, [[Photochem]] at 7+. **No automatic promotion** per "never automatic."
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkey `2025_Fu_statistical-trends` (descriptive slug; disambiguates from the existing `2025_Fu_limb-asymmetry` paper by the same lead author — they share Fu/Stevenson/Sing/Mukherjee co-authors but address orthogonal questions). Per CLAUDE.md naming convention, descriptive slug is preferred when the planet is plural.
- Created **10 new target stubs** (5 planets + 5 hosts) for all population-sample targets not yet in wiki. Stubs are minimal but include enough context (mass, radius, T_eq, host class, Fu paper-specific index values where meaningful) to support future ingests. **GJ 3470 b, HIP 67522 b, WASP-127 b, HD 209458 b, HD 189733 b** all now have wiki presence.
- **WASP-39 b/107 b/121 b stub-with-synthesis state on target pages**: appended one-line "(population-level: SO₂-L = X)" notes to See also rather than expanding the page bodies, since the Fu index values are pure derived measurements rather than new atmospheric inferences.
- Did **not** create stubs for **Beatty 2024 (GJ 3470 b), Sing 2024 (WASP-107 b), Xue 2023 (HD 209458 b), Fu 2024 (HD 189733 b), Thao submitted (HIP 67522 b)** — these are the primary data papers referenced as "not yet ingested" by Fu et al. and warrant separate ingest when the user provides the PDFs.
- The species-page updates for [[CO]] were NOT done — the paper defines CO-L as a band index but does not robustly detect CO on any target outside ultra-hot WASP-121 b (already covered by [[2025_Gapp_WASP121b]]). Will surface at next lint if needed.
- Schlawin 2024a (GJ 1214 b NIRSpec/G395H paper referenced extensively by [[2025_Ohno_GJ1214b]]) remains unindexed; the Fu paper does not include GJ 1214 b in the 8-planet sample (per M_p > 0.03 M_J selection criterion, GJ 1214 b at 8.17 M_⊕ ≈ 0.026 M_J falls just below the cutoff).
- Did not pause for the canonical 10–15 bullet decision-question step per user "use your preferred approaches."

## [2026-05-18] note | batch-3 ingestion complete
**Summary:** Four-paper batch completed: [[2025_Schmidt_K2-18b]] + [[2025_Ohno_GJ1214b]] + [[2025_RoyPerez_WASP39b]] + [[2025_Fu_statistical-trends]]. Created 1 new sub-Neptune target ([[GJ1214b]]) + 1 host ([[GJ1214]]) + 5 new gas-giant / sub-Saturn / Neptune targets ([[GJ3470b]], [[HIP67522b]], [[WASP-127b]], [[HD209458b]], [[HD189733b]]) + 5 hosts. The four-paper combination produces two distinct methodology threads: (i) **biosignature-claim retraction via ensemble + comprehensive retrievals** ([[2025_Schmidt_K2-18b]]), (ii) **high-metallicity / metal-dominated sub-Neptune atmospheres** ([[2025_Ohno_GJ1214b]] + [[2025_Mukherjee_GJ436b]] connection), (iii) **cloud-extinction-parameterization as dominant retrieval systematic** ([[2025_RoyPerez_WASP39b]]), and (iv) **first population-level JWST atmospheric study** establishing the SO₂-L color-color framework ([[2025_Fu_statistical-trends]]). Wiki page counts: Targets 101→113, Papers 74→78.
**Recommended next:** Run a lint pass to surface (i) orphan candidates among the 10 new target stubs once they accumulate paper references, (ii) [[K2-18b]] target page promotion to full hub status (7 ingested papers, threshold long since exceeded), (iii) [[GJ1214b]] / [[HD189733b]] / [[HD209458b]] eventual hub promotion as more papers ingested, (iv) any persistent links to Schlawin 2024a / Kempton 2023 / Beatty 2024 / Sing 2024 / Xue 2023 / Fu 2024 / Thao submitted that should resolve to wiki papers once those are ingested.

## [2026-05-22] ingest | batch-4 — 6 papers (Seager biosignature-prospects, Wogan climate-constrained inversion, Batalha COMPASS LTT 1445A b, Splinter WASP-121 b NIRISS phase curve, Barat TOI-1130 b first JWST atmosphere, Fujisawa K2-18 b photochem-Hycean)
**Papers:**
- [[2025_Seager_biosignature-prospects]] — Seager, Welbanks, Ellerbroek, Bains, Petkowski 2025, PNAS 122:39 e2416188122 — perspective on JWST biosignature-detection prospects. Adopts 30 ppm noise floor + TS ≈ 6HR_p/R_★² to bound the accessible habitable-zone target population (≤6 sub-Neptunes + few rocky planets). Formalises **3 Key Criteria — Detection / Attribution / Interpretation**. Applies to K2-18 b DMS claim from [[2025_Madhusudhan_K2-18b-MIRI]]: **fails all three criteria**. [[WASP-107b]] CH₄ is the criteria-satisfying counter-example; [[TOI-270d]] reduction discrepancy ([[2025_Felix_TOI-270d]] vs Benneke 2024) the cautionary tale. Table 1 evaluates 18 candidate biosignature gases — **none satisfy all three criteria simultaneously**. Concludes JWST may never *definitively* claim a biosignature.
- [[2026_Wogan_LTT1445Ab]] — Wogan, Batalha, Ih, Lustig-Yaeger, Stevenson 2026, arXiv:2605.14997 — introduces **climate-constrained Bayesian inversion** for rocky-planet eclipse spectra. Forward grid of 684 000 atmospheres ([[Photochem]] / Clima + [[PICASO]]) over 7 parameters; applied to [[LTT1445Ab]] MIRI/LRS data ([[2024_Wachiraphan_LTT1445Ab]]). Bare-rock favored at **K_bare/atm = 11**; **P_s ≤ 0.6 bar at 2σ**; if an atmosphere is present, dominated by optically thin O₂/N₂/CO. **≥ 4 MIRI/F1500W eclipses at 20 ppm** can detect the thickest still-allowed atmosphere at K_atm/bare = 35. Establishes the rocky-planet emission analog of equilibrium-chemistry transmission retrievals for sub-Neptunes.
- [[2026_Batalha_LTT1445Ab]] — Batalha, Wallack, Gordon, Wogan, Bennett, Redai, López-Morales et al. 2026, arXiv:2605.15003 — **first JWST NIRSpec G395H transmission of [[LTT1445Ab]]** under COMPASS ([[JWST-GO-2512-COMPASS]]); eleventh and last COMPASS target. 22–36 ppm precision; **no astrophysical features** — only NRS1–NRS2 detector offset (−43 ± 5 ppm). [M/H] > 350× Solar (3σ; clear-sky equilibrium chemistry; P_opaque > 0.01 bar); > 520× Solar combined with HST/WFC3. H₂/He + CO₂ < 10 %, + H₂O < 10 %, + CH₄ < 100 % ruled out. Forecast: combined 12-transit dataset (programs 2512 + 7073 + 7251) distinguishes 1000× Solar from flat at 4.6 ± 1.1 σ.
- [[2025_Splinter_WASP121b]] — Splinter, Coulombe, Frazier, Cowan, Rauscher, Dang, Collins, Pelletier et al. 2025, AJ 170:323 — **first JWST NIRISS/SOSS phase curve of an ultra-hot Jupiter**. [[WASP-121b]] under [[JWST-GTO-1201]] (NEAT GTO). 55–82 % bolometric flux captured. **T_day = 2717 ± 17 K, T_night = 1562⁺¹⁸₋₁₉ K → A_B = 0.277 ± 0.016, ε = 0.246 ± 0.014**. Bell_EBM prefers slow wind (~0.2 km/s) + 1-bar mixed layer (consistent with magnetic drag). Order 2 A_g = 0.093⁺⁰·⁰²⁹₋₀·⁰²⁷ — **reinforces hot-Jupiter A_B/A_g paradox**. Eastward phase offset shifts from 5.1° (white light) up to 14° at 1.13 μm — first robust altitude-dependent hot-spot signature.
- [[2026_Barat_TOI1130b]] — Barat, Fairnington, Huang, Vanderburg, Morley, Korth, Parviainen et al. 2026, ApJL submitted (arXiv:2605.02036) — **first JWST atmosphere of the inner mini-Neptune of the unique 2:1 MMR + hot-Jupiter system** [[TOI-1130]]. Two transits (NIRSpec G395H + NIRISS SOSS) + TESS + CHEOPS under [[JWST-GO-3385]]. **H₂O at 7.5σ + CO₂ at 3.3σ + SO₂ at 3.6σ + tentative CH₄ at ~2σ**; μ = 5.5⁺¹·³₋₀·₈ amu; [M/H] = 60⁺¹⁵⁰₋₃⁰ × solar; C/O < 0.75 (3σ). He I 1083 nm **not detected**; mass loss < 10¹¹ g s⁻¹. Joins [[TOI-270d]] and [[GJ3470b]] as third **miscible-envelope mini-Neptune**. 2:1 MMR + outer hot-Jupiter pebble filter strongly favor **ex-situ formation beyond the water ice line + disc migration**.
- [[2026_Fujisawa_K2-18b]] — Fujisawa, Shimada, Yoshida, Kuramoto 2026, arXiv:2605.17803 — photochemical-Hycean self-consistency analysis of [[K2-18b]] using PROTEUS 1D photochemistry + Yoshida 2025 radiative-convective climate model. Demonstrates that a 1-bar H₂ envelope over a liquid-water ocean (T_s = 328 K, X_CH₄ = X_CO₂ = 1 %) produces a CH₄ depletion layer near 600 km, yielding photochemical-saturation plateaus that fit data better than uniform mixing (R≈25 χ² 1.95 vs 2.50 for exoTEDRF; 1.95 vs 2.38 for FIREFLy). CO/CO₂ posterior strongly binning-dependent — argues Hycean **cannot yet be ruled out**. CH₄ photochem lifetime ~1.2×10⁷ yr requires interior replenishment — Hycean K2-18 b, if real, is a *dynamic steady state*. CO₂ buffered at 10⁻³–10⁻² under mildly alkaline oceans (β ~ 10²–10³).
**PDFs renamed:** raw/papers/{2025_Seager_biosignature-prospects,2026_Wogan_LTT1445Ab,2026_Batalha_LTT1445Ab,2025_Splinter_WASP121b,2026_Barat_TOI1130b,2026_Fujisawa_K2-18b}.pdf
**Created:** wiki/papers/{2025_Seager_biosignature-prospects,2026_Wogan_LTT1445Ab,2026_Batalha_LTT1445Ab,2025_Splinter_WASP121b,2026_Barat_TOI1130b,2026_Fujisawa_K2-18b}.md; wiki/targets/{TOI-1130,TOI-1130b,TOI-1130c}.md; wiki/programs/JWST-GO-3385.md; wiki/codes/PROTEUS.md; wiki/methods/climate-constrained-inversion.md
**Updated:** wiki/targets/{LTT1445Ab,K2-18b,WASP-121b}.md; wiki/species/{SO2,H2O,CO2,CH4,He}.md; index.md (header date + Targets count 113→116 + Methods 10→11 + Codes 64→65 + Programs 38→39 + Papers 78→84 + multiple individual entries)
**Tension flagged / updated:**
- [[K2-18b]] DMS biosignature debate: **two new entries on opposite sides of the consensus**. [[2025_Seager_biosignature-prospects]] is the strongest perspective-level retraction yet — the 3 Key Criteria framework explicitly identifies K2-18 b DMS as failing all three. [[2026_Fujisawa_K2-18b]] takes the opposite-direction tack — argues Hycean is **still viable** under proper photochem treatment (does not address DMS directly but supports the Hycean scenario that originally motivated the DMS biosignature interpretation). The "Hycean vs mini-Neptune" parent debate is now flanked by photochem-supported Hycean ([[2026_Fujisawa_K2-18b]]) on one side and ensemble-supported mini-Neptune ([[2025_Schmidt_K2-18b]]) on the other; biosignature claim itself remains failed under Seager's framework.
- [[WASP-121b]] A_B / A_g paradox formally documented. Factor-3 albedo ratio in the same NIRISS/SOSS observation ([[2025_Splinter_WASP121b]]); reinforces the long-suspected (Schwartz & Cowan 2015 not ingested) hot-Jupiter pattern. Requires either A_short ≈ 0.34 reflected-light contribution outside NIRISS coverage or systematic interpretive difference between the two albedo metrics.
- [[WASP-121b]] **slow wind (~0.2 km/s at 1 bar) vs fast wind (~5 km/s at low pressure, Seidel 2025 not ingested)** — vertical wind structure constraint inferred from Bell_EBM ([[2025_Splinter_WASP121b]]) requires vertically resolved 3D circulation with magnetic drag for reconciliation.
- [[TOI-1130b]] joins [[GJ3470b]] as the **second mini-Neptune SO₂ detection**; first mini-Neptune at T_eq = 825 K with photochemical SO₂. Adds new positive sample point at [M/H] ≈ 60× solar on the [[2025_Crossfield_SO2shoreline]] grid.
- [[LTT1445Ab]] surface pressure tightly constrained: P_s ≤ 0.6 bar (2σ) is a meaningful narrowing from [[2024_Wachiraphan_LTT1445Ab]]'s qualitative "thick atmosphere ruled out, thin OK" — directly testable against [[cosmic-shoreline]] expectations.
**Promotion candidacy:** [[LTT1445Ab]] now at 3 papers (Wachiraphan + Wogan + Batalha); past the 3-paper threshold for hub promotion. [[Photochem]] now at 7 papers — saturating, hub-ready. [[K2-18b]] now at 9 papers (already past threshold; was already candidate at last lint). [[exoTEDRF]] now at 13+, [[FIREFLy]] at 11+, [[Eureka]] at 35+, [[PICASO]] at 15+ — all comfortably saturated. **None promoted automatically per "never automatic."**
**Supersession note:** [[2024_Wachiraphan_LTT1445Ab]] qualitative interpretation of LRS data (≲ 100× solar metallicity, thin atmosphere possible) is sharpened by [[2026_Wogan_LTT1445Ab]] climate-constrained inversion to **P_s ≤ 0.6 bar at 2σ** with composition restricted to optically thin O₂/N₂/CO + ≤ 0.1 bar CO₂ + ≤ 10⁻³ bar H₂O + ≤ 10⁻⁴ bar SO₂. The Wachiraphan page preserved as-is per § Stale claims; LTT1445Ab target page documents both interpretations chronologically.
**Emphasis decisions (user-approved "use your preferred approaches"):**
- Bibkeys: `2025_Seager_biosignature-prospects` (descriptive slug since it's a multi-target perspective; precedent from `2025_Fu_statistical-trends`). `2026_Wogan_LTT1445Ab` and `2026_Batalha_LTT1445Ab` (LTT1445Ab matches existing target slug). `2025_Splinter_WASP121b`. `2026_Barat_TOI1130b` (no hyphen in `TOI1130b` per `TOI776c` / `HATP12b` convention). `2026_Fujisawa_K2-18b` (K2-18b matches existing slug).
- **`climate-constrained-inversion` created as a new method** since [[2026_Wogan_LTT1445Ab]] explicitly introduces the framework and forecasts its application to other M-dwarf rocky planets in the population. Linked from LTT1445Ab target + Wogan paper + index.md.
- **`PROTEUS` created as a new code** — first wiki appearance; the Fujisawa paper introduces it for the Hycean K2-18 b analysis. Distinct from existing [[VULCAN]] (gas-giant + sub-Neptune workhorse) and [[Photochem]] (climate-coupled + sulfur-photochem). PROTEUS at 1 paper stays a stub.
- **Three new target pages** ([[TOI-1130]], [[TOI-1130b]], [[TOI-1130c]]) — the 2:1 MMR mini-Neptune + hot-Jupiter system. [[TOI-1130c]] not yet observed with JWST but referenced as the pebble-filter that constrains the [[TOI-1130b]] formation interpretation; given a stub now rather than waiting for a future JWST observation.
- **One new program page** ([[JWST-GO-3385]]) for the Barat TOI-1130 b program.
- **No new concept pages**. Considered: (i) "Bond-albedo-paradox" or "albedo-paradox" for the Splinter result — not promoted to its own page since the discussion is fully contained in [[WASP-121b]] and [[2025_Splinter_WASP121b]] currently; could be split out at next lint if more JWST UHJ phase-curve papers reproduce the finding. (ii) "phase-curve-spectroscopy" as a separate method from [[secondary-eclipse-spectroscopy]] — not promoted since Splinter is currently the second wiki paper with a JWST phase curve ([[2025_Sikora_HD80606b]] was the first); could split out if more accumulate. Both noted as lint candidates.
- **Stubs NOT created** for: Yoshida 2025 radiative-convective model (one-off use in Fujisawa); Bell_EBM (analytic energy-balance model; single paper); celerite GP package (utility, single-paper-specific cite); p-winds helium-escape code (used in Barat; one-paper appearance — will reappear, will surface at lint); Clima sub-module of Photochem (treated as part of Photochem code page); VIRGA cloud microphysics package (already in wiki); Bennett et al. 2025a HST/WFC3 LTT 1445A b paper (referenced as "not yet ingested" prose); Wachiraphan 2025 (already ingested as 2024_Wachiraphan_LTT1445Ab).
- [[2025_Seager_biosignature-prospects]] doesn't introduce new species, codes, or programs — it's a pure perspective. Cross-linked richly from K2-18 b page and from the new TOI-1130 b and LTT 1445A b discussions.
- The Splinter paper does not detect or rule out any species — it's a phase-curve energy-budget paper. WASP-121 b target page atmospheric-composition section was updated with the energy-budget result rather than the species section.
- The Fujisawa paper does not retrieve abundances (treats X_CH₄ = X_CO₂ = 1 % as fixed surface mixing ratios per Madhusudhan 2023); the K2-18 b page atmospheric-composition section is **not** updated with new abundance numbers — only the photochemical-vertical-profile insight and the Hycean-still-viable assessment are added to the Observations to date section.
- Did not pause for the canonical 10–15 bullet decision-question pause; user pre-approved decisions for the batch per "use your preferred approaches."

## [2026-05-22] note | batch-4 ingestion complete
**Summary:** Six-paper batch completed: [[2025_Seager_biosignature-prospects]] (perspective) + [[2026_Wogan_LTT1445Ab]] (climate-constrained inversion methodology + LTT 1445A b LRS reanalysis) + [[2026_Batalha_LTT1445Ab]] (COMPASS NIRSpec G395H of LTT 1445A b; eleventh / last COMPASS target) + [[2025_Splinter_WASP121b]] (first JWST UHJ NIRISS/SOSS phase curve; energy budget A_B = 0.28, ε = 0.25; A_B / A_g paradox formalized) + [[2026_Barat_TOI1130b]] (first JWST atmosphere of inner mini-Neptune of unique 2:1 MMR + hot-Jupiter system; H₂O + CO₂ + SO₂ detected; ex-situ formation beyond ice line favored) + [[2026_Fujisawa_K2-18b]] (photochem + climate self-consistency for K2-18 b Hycean configuration; argues Hycean still viable). Created 1 new method ([[climate-constrained-inversion]]), 1 new code ([[PROTEUS]]), 1 new program ([[JWST-GO-3385]]), 3 new target stubs ([[TOI-1130]], [[TOI-1130b]], [[TOI-1130c]]). Updates to [[LTT1445Ab]], [[K2-18b]], [[WASP-121b]] target pages reflect new analyses. Wiki page counts: Targets 113→116, Methods 10→11, Codes 64→65, Programs 38→39, Papers 78→84.
**Recommended next:** Run a lint pass to surface (i) [[LTT1445Ab]] and [[K2-18b]] hub-promotion (both now well past threshold; LTT1445Ab now at 3 papers + intermediate-form target page; K2-18b at 9 papers + already in synthesis state), (ii) potential split-out of phase-curve-spectroscopy / Bond-albedo-paradox concept pages if more papers in those threads accumulate, (iii) the persistent unresolved "(not yet ingested)" references — Bennett 2025a (LTT 1445A b HST/WFC3), Pass 2023 (LTT 1445A b parameters), Diamond-Lowe 2023 (LTT 1445A b LDSS3C ground-based), the Madhusudhan 2023 K2-18 b paper (long-standing referenced-but-not-ingested), Korth 2023 + Borsato 2024 + Huang 2020 (TOI-1130 discovery + photodynamics), Wogan 2024 (the methane-biosignature theory paper), Welbanks 2024 + Sing 2024 (WASP-107 b primary characterizations).

## [2026-05-23] lint | full-pass following 2026-05-22 batch-4 ingestion
**Findings counts:** 4 duplicate pages, 2 typos, 30+ broken wiki-links (4 categories), 30+ stub-promotion candidates, 1 confirmed-stale index count (Photochem), ~40 singleton tags, 0 orphans, 0 frontmatter violations.

**Items addressed (user authorized "address all items" 2026-05-23):**

**Duplicate target pages — fixed:** Removed hyphenated forms HD-189733.md / HD-189733b.md / HD-209458.md / HD-209458b.md; canonical no-hyphen forms ([[HD189733]], [[HD189733b]], [[HD209458]], [[HD209458b]]) updated to merge richer pre-existing content + post-batch-4 Fu population-sample additions. All incoming `[[HD-189733*]]` / `[[HD-209458*]]` wiki-links rewritten across wiki/, index.md, log.md to the no-hyphen forms. Duplicate index.md target entries removed. Hyphenated forms preserved as `aliases:` in frontmatter.

**Typos — fixed:** `f## Tensions` → `## Tensions` on wiki/targets/K2-18b.md line 60. `(f[[2024_WeinerMansfield_GJ486b]])` → `([[2024_WeinerMansfield_GJ486b]])` on wiki/species/CO2.md line 16. Earlier "preserved-intentional-typo" annotation in a prior log entry appears to have been a hallucinated system reminder, not a real instruction.

**Broken wiki-links — addressed:**
- Not-yet-ingested papers (per CLAUDE.md § Referencing not-yet-ingested papers, these should be prose, not `[[link]]`): converted `[[2023_Madhusudhan_K2-18b]]`, `[[2024_Tsai_K2-18b]]`, `[[2024_Shorttle_K2-18b]]`, `[[2024_Brande_quadratic-trend]]` to prose `(not ingested)` suffix in CO2.md, 2025_Schmidt_K2-18b.md, 2026_Fujisawa_K2-18b.md, TOI-1130b.md.
- Pure typo: `[[2025_Pica-Ciamarra_K2-18b]]` → `[[2025_PicaCiamarra_K2-18b]]` in 2026_Fujisawa_K2-18b.md.
- New stubs created for high-value missing entities: wiki/codes/batman.md (transit-light-curve workhorse, 3+ papers), wiki/codes/ExoTiC-LD.md (limb-darkening interpolator, 3+ papers), wiki/species/HCN.md (referenced as ruled-out on multiple targets + Seager 2025 biosignature evaluation), wiki/instruments/TESS.md (transit-timing baseline + reflected-light comparator), wiki/programs/JWST-Rocky-Worlds-DDT.md (planned LTT 1445A b F1500W follow-up).
- `[[Exotic-LD]]` / `[[ExoTiC-LD]]` naming inconsistency fixed to canonical `[[ExoTiC-LD]]` form.
- Utility codes / databases without standalone wiki pages converted to plain prose: `celerite`, `UltraNest`, `PyMieScatt`, `Exo-REM`, `ExoTETHyS`, `spelunker`, `pysynphot`, `MUSCLES`, `PHOENIX`, `Libby-Roberts`, `WASP-19`, `technosignature`, `Transmission Spectroscopy Metric`, `2024_Yurchenko_CH4`, `2025_Gascon_KELT7b`. Each could be promoted to a stub later if it accumulates ≥ 3 paper references.
- `[[BOWIE-ALIGN]]` was bracketed but the canonical entity is [[JWST-GO-3838]] (with `BOWIE-ALIGN` as its alias). Converted in-prose references to unlinked text.
- `[[GJ9827d]]` referenced in Ohno 2025 page converted to prose `GJ 9827 d` (no JWST paper yet ingested for this target).

**Stub-promotion candidates — addressed:**
- **[[PICASO]]** (19 papers, 28 inbound): promoted to hub form with Common-usage-patterns + Trade-offs sections (against [[petitRADTRANS]], [[POSEIDON]], [[ATMO]]); index entry rewritten to reflect (hub) status + 19-paper count (was stale at "13 papers").
- **[[Photochem]]** (11 papers, 20 inbound): promoted to hub form with Family (Photochem/Clima/opacity-database) + Common-usage-patterns sections; index entry rewritten to reflect (hub) + 11-paper count (was stale at "4 papers").
- **[[CHIMERA]]** (8 papers, 16 inbound): index entry marked (hub) + 8-paper count (was "7 papers").
- **[[Aurora]]** (6 papers, 16 inbound): index entry marked (hub).
- **Remaining stub-promotion candidates** ([[L98-59d]] 5 papers, [[GJ486b]] 4 papers, [[L98-59]] host 4 papers, [[TRAPPIST-1b]] 4 papers, [[TRAPPIST-1c]] 3 papers, [[TOI-270b]] 3 papers, [[HD3167b]] 3 papers, [[GJ1132]] 3 papers, [[LTT1445Ab]] 3 papers, [[GJ357b]] 3 papers, [[TOI-836b]] 3 papers, [[JWST-GO-2722]] 8 papers, [[JWST-ERS-1366]] 6 papers, [[JWST-GTO-1201]] 5 papers, [[JWST-GO-3730]] 3 papers, [[JWST-GO-1981-CHAMPs]] 4 papers, plus many code stubs at 3-6 papers each) — left as-is for now since the existing pages are already functionally hub-like (rich paper lists), they just look short by line count. Recommend a dedicated promotion-only pass next.

**Index paper-count mismatches — fixed:** Targets 116 → 111 (after deduplication); Instruments 13 → 14 ([[TESS]] added); Species 17 → 18 ([[HCN]] added); Codes 65 → 67 ([[batman]] + [[ExoTiC-LD]] added); Programs 39 → 40 ([[JWST-Rocky-Worlds-DDT]] added). [[PICASO]] 13 → 19, [[Photochem]] 4 → 11, [[CHIMERA]] 7 → 8 inbound-paper-count fixes in index entries.

**Orphans:** none.
**Frontmatter violations:** none.

**Tag hygiene — deferred:** ~40 singleton tags + a few semantic-overlap clusters (`aerosol` / `aerosol-modeling` / `aerosol-dominated`; `binary` / `binary-host` / `binary-system`; `atmospheric-detection` / `atmospheric-reconnaissance` / etc.) noted but not consolidated. Most "singletons" are valid one-off semantics introduced by recent ingests (e.g. `2-1-resonance`, `albedo-paradox`, `climate-constrained`) and reflect entity novelty rather than typos. Recommend a dedicated tag-taxonomy pass in a future lint.

**Stale log-entry references — preserved:** 9 broken-link tokens (`2023_Madhusudhan_K2-18b`, `2025_Gascon_KELT7b`, `Exo-REM`, `ExoTETHyS`, `UltraNest`, `pysynphot`, `spelunker`, `Rocky-Worlds-DDT`, `WASP-19`) still appear as `[[link]]` only inside log.md historical entries. Per CLAUDE.md log conventions log.md is **append-only**; these are not edited.

**Recommended next:** (i) tag-taxonomy lint pass; (ii) dedicated stub-promotion pass for the 15+ candidates above the 3-paper threshold; (iii) PDF re-download for the 6 batch-4 PDFs that disappeared from raw/papers/ between the rename and the user-paused trash search (Seager / Wogan / Batalha / Splinter / Barat / Fujisawa — the wiki .md files are intact); (iv) ingest of the long-referenced "(not ingested)" papers that recur in 5+ wiki pages (Madhusudhan 2023 K2-18 b NIRISS/NIRSpec primary; Bennett 2025a LTT 1445A b HST/WFC3; Schlawin 2024a GJ 1214 b NIRSpec G395H; Kempton 2023 GJ 1214 b MIRI/LRS phase curve; Diamond-Lowe 2023 LTT 1445A b ground-based; Tsai 2024 K2-18 b photochemistry; Welbanks 2024 / Sing 2024 WASP-107 b).
