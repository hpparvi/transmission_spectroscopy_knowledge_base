...
- [[2025_Ohno_GJ1214b]] — **radiative-transfer backbone** for the photochemical-microphysical (PM) haze grid on [[GJ1214b]] panchromatic HST/WFC3 + NIRSpec/G395H + MIRI/LRS spectrum. Provides forward transmission models (correlated-k; H₂O POKAZATEL, CO/CO₂ Freedman & UCL-4000, NH₃, HCN, H₂S, CH₄, C₂H₂, C₂H₄, C₂H₆, CH₃Cl, CS, SO, SO₂, OCS) given downstream [M/H], C/O, K_zz, F_haze grid sampling. Chemically-consistent retrieval variant (FastChem2 abundances + Guillot TP profile + power-law κ_aer) gives [M/H] = 3.48⁺⁰·⁴²₋₀·³⁶, in agreement with the PM grid result.
