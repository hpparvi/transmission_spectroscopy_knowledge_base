...
- [[2025_Luque_K2-18b]] — SCARLET free-chemistry retrievals on independent K2-18 b panchromatic reductions (exoTEDRF all-instruments + exoTEDRF NIRISS / SPARTA NIRSpec+MIRI); baseline includes H₂O, CO, CO₂, CH₄, NH₃, HCN, C₂H₆; DMS/DMDS adds Δln Z = 2.3–2.8; comparator framework against [[PLATON]].
