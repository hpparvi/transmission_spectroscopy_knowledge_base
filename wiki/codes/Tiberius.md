...
## Papers
- [[2025_Ahrer_KELT7b]] — one of three independent reductions (alongside [[Eureka]] and [[ExoTiC-JEDI]]) for the KELT-7 b NIRSpec G395H BOWIE-ALIGN transit; uses identical reduction parameters across BOWIE-ALIGN sample to avoid reduction-dependent biases.
...
- [[2025_Deka_WASP39b]] — one of three MIRI reductions (Eureka, Tiberius, SPARTA) cross-compared on WASP-39 b within the [[NEXOTRANS]] retrieval framework benchmark.
