...
- [[2025_Luque_K2-18b]] — Eureka used as one of four reductions for K2-18 b NIRSpec G395H + MIRI/LRS; matches the JExoRES choices in [[2025_Madhusudhan_K2-18b-MIRI]]. R = 200 NIRSpec; 0.25 μm bins on MIRI; 4-pixel half-width box extraction; first 250 integrations masked.
- [[2025_Carter_NIRISS-jump-ramp]] — Eureka used for light-curve binning + fitting (R = 100) across both default-pipeline and LIKELY-method reductions of WASP-39 b NIRISS/SOSS in the methodology study.
- [[2025_BelloArufe_L98-59b]] — primary Eureka! v0.10 reduction of 4 NIRSpec G395H transits of L 98-59 b. 4σ → 7σ jump threshold; mean group-level background subtraction; 13-pixel boxcar optimal extraction; 10σ outlier rejection. Cross-checked with [[FIREFLy]] at < 1σ. Used as input to ExoTR / Aurora / POSEIDON retrievals.
- [[2025_Canas_TOI5205b]] — Eureka! reduction (with [[spotrod]] integration for spot modeling) on 3 NIRSpec PRISM transits of TOI-5205 b; cross-checked with [[ExoTiC-JEDI]] at < 1σ.
- [[2025_Mukherjee_GJ436b]] — Eureka! v0.11 used as one of two reductions (cross-check vs [[Tshirt]]) on 6× NIRCam + 2× MIRI/LRS eclipses of GJ 436 b; 6σ NIRCam / 8σ MIRI jump threshold; GP detrending with celerite2 + Matérn-3/2.
