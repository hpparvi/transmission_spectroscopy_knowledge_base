...
## Papers
- [[2026_Ashtari_HATS75b]] — TLS modeling on a GEMS gas giant: unocculted spots (T ≈ 3365 K, f ≈ 0.23) + faculae (T ≈ 3909 K, f ≈ 0.25) on the M-dwarf host, retrieved jointly with the planetary atmosphere; TLS+atmosphere preferred over hazy clear-atmosphere based on independent activity evidence.
