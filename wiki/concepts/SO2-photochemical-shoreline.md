...
- [[2025_Fu_statistical-trends]] — **first population-level empirical SO₂ scan** across 8 hot-Jupiter / sub-Saturn JWST targets via the SO₂-L band-index method. Confirms the photochemical-shoreline scenario: SO₂-L correlates negatively with T_eq (r = −0.64) and positively with bulk Z fraction (r = 0.54 for T_eq < 1400 K), consistent with the [[2025_Crossfield_SO2shoreline]] theoretical map. Provides the first systematic empirical-vs-theory comparison for the shoreline picture.
